              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '' }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img className="inline-block w-10 h-10 rounded-full" src="https://img.freepik.com/premium-photo/cartoon-girl-wearing-hat-scarf-with-scarf-around-her-neck-generative-ai_1034044-11197.jpg?ga=GA1.1.967407136.1708519265&semt=ais_user" alt="Dan_Abromov" />
                    </Link>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    <img src="https://img.freepik.com/free-vector/illustration-nigeria-flag_53876-27148.jpg?ga=GA1.1.967407136.1708519265&semt=ais_user" alt="" className="block h-auto w-5 flex-shrink-0" />
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      src="https://img.freepik.com/free-vector/illustration-nigeria-flag_53876-27148.jpg?ga=GA1.1.967407136.1708519265&semt=ais_user"
                      alt=""
                      className="block h-auto w-5 flex-shrink-0"
                    />
                    <span className="ml-3 block text-sm font-medium" style={{ color: mode === 'dark' ? 'white' : '', }}>NIGERIA</span>
                  </a>
                </div>
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
