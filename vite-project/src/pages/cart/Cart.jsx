  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gray-100 pt-5 pb-10" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '' }}>
        ...
        <div className="mx-auto max-w-5xl px-6 flex flex-col md:flex-row md:space-x-6 xl:px-0">
          <div className="rounded-lg md:w-2/3">
            {cartItems.map((item, index) => {
              const { title, price, description, imageUrl } = item;
              return (
                <div key={index} className="mb-6 rounded-lg border drop-shadow-xl bg-white p-6 flex flex-col sm:flex-row sm:justify-between" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '' }}>
                  <img src={imageUrl} alt="product-image" className="w-full rounded-lg sm:w-40" />
                  <div className="mt-5 sm:mt-0 sm:ml-4 flex flex-col sm:flex-row sm:justify-between w-full">
                    <div>
                    ...
                    <div onClick={() => deleteCart(item)} className="mt-4 flex justify-end sm:justify-between sm:space-y-6 sm:mt-0 sm:space-x-6">
