                                        ...
                                        <tbody className=''>
                                            <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                ...
                                                <th scope="row" className="px-6 py-4 font-medium text-black whitespace-nowrap">
                                                    <img className='w-16' src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhhVxfUsk7ar5xRCKMgdhBId1euIojBwir6SOyjHiVSe65E-jDmaAuvjLXrOdXj9jT3iYp0Jjew2zwRc77yNBfHN3K3bwd44dNOXXdQIB9FB36I3D-pTSZAryfYwaB9D3NlHpBplYpZDZCFkf4m-1tc8NN7VbhC6ojosHIjhEI0mBhXKE8WoScwg7oNaWQ/s320/capBrown7K.jpeg" alt="img" />
                                                </th>
                                                <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                    Title
                                                </td>
